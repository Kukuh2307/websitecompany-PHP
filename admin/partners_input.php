...
if($id != ""){
  $queryedit = "SELECT * FROM partners WHERE id='$id'";
...
if(isset($_POST['simpan'])){
  ...
  if($_FILES['foto']['name']) {
    ...
    // error
    // Array ( [dirname] => . [basename] => partners.jpg [extension] => jpg [filename] => partners )
    // print_r($_FILES);
  ...
  if($id != ""){
    ...
    $foto_name = $foto;
      // updatedata
      $queryupdate = "UPDATE partners SET nama = '$nama', foto = '$foto_name', isi='$isi',tgl_isi=now() WHERE id = '$id'";
    ...
    // menegecek apakah data terisi semua
      ...
      $queryinsert = "INSERT INTO partners(nama,foto,isi) VALUES ('$nama','$foto_name','$isi')";
